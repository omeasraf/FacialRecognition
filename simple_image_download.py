# OG https://github.com/RiddlerQ/simple_image_download
...
class simple_image_download:
    ...
    def urls(self, keywords, directory, limit, extensions={'.jpg', '.png', '.ico', '.gif', '.jpeg'}):
    ...
    def download(self, keywords, directory, limit, extensions={'.jpg', '.png', '.ico', '.gif', '.jpeg'}, recursive: bool = False):
        keyword_to_search = [str(item).strip() for item in keywords.split(',')]
        main_directory = f"Images/Known/"
        i = 0
        ...
        while i < len(keyword_to_search):
            self._create_directories(main_directory, directory)
            url = 'https://www.google.com/search?q=' + quote(
